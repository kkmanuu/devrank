...
<body>
    <div class="d-flex">
        ...
        <nav class="sidebar d-flex flex-column p-3">
            ...
            <ul class="nav nav-pills flex-column">
                <li class="nav-item">
                    <a href="{{ route('dashboard') }}" class="nav-link {{ Route::is('dashboard') ? 'active' : '' }}"><i class="bi bi-house me-2"></i>Dashboard</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('project.create') }}" class="nav-link {{ Route::is('project.create') ? 'active' : '' }}"><i class="bi bi-code-slash me-2"></i>Submit Project</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('coaching.index') }}" class="nav-link {{ Route::is('coaching.index') ? 'active' : '' }}"><i class="bi bi-person-video3 me-2"></i>Coaching</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('messages.index') }}" class="nav-link {{ Route::is('messages.index') ? 'active' : '' }}"><i class="bi bi-chat-square-text me-2"></i>Messages</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('profile.edit') }}" class="nav-link {{ Route::is('profile.edit') ? 'active' : '' }}"><i class="bi bi-person me-2"></i>Profile</a>
                </li>
                <li class="nav-item">
                    ...
                    <div class="row g-4">
                        @foreach($submissions as $submission)
                            <div class="col-md-6">
                                <div class="card p-3">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $submission->project->title }}</h5>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card p-3">
                                            <div class="card-body">
                                                ...
                                                <p><strong>Date:</strong> {{ $session->session_date->format('Y-m-d H:i') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
    ...
    <script>
        const submissionChart = document.getElementById('submissionChart').getContext('2d');
